...
plt.plot(data_music.index, weighted_avg_reference_EPP_list, marker='o', linestyle='-', color='b', label='Real EPP')
plt.plot(data_music.index, data_music['Generated_EPP_Normalized'], marker='o', linestyle='-', color='r',
