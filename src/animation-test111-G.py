...
# Sort normalized real EPP and generated EPP values
sorted_real_EPP = sorted(real_EPP_values)
sorted_generated_EPP_normalized = sorted(data['Generated_EPP_Normalized'])

# Create spline interpolation models for smoothing
...
# Generate smoothed curves after interpolation
...
# Calculate fitting relationship (linear fit between real EPP and generated EPP using least squares method)
...
# Plot smoothed convergence curves of normalized real EPP and generated EPP
...
# Plot fitted trend line (represents linear convergence relationship between the two)
